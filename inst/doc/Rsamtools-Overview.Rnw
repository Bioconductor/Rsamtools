...
The essential function provided by \Rsamtools{} is \bam{} input. This
is accomplished with the \Rfunction{scanBam}
...
files that exactly six \texttt{'.'} characters in tehir name (this
